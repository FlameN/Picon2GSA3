...
#define USERPROGRAMM_LOCATION		(0x00102000)

#define USERPROGRAMM_LOCATION_NR	(USERPROGRAMM_LOCATION - 0x00100000)
#define SIGNATURE_LOCATION_NR		(SIGNATURE_LOCATION - 0x00100000)
...
#define DEVICE_CONST_WORDS	(0x0B00)
#define DEVICE_PROG_WORDS	(0x4000)

#define DEVICE_FLASHMEM_WORDS	(DEVICE_CFG_WORDS+DEVICE_CONST_WORDS+DEVICE_CONST_WORDS)

#define DEVICE_FLASHMEM_LOCATION	(0x140000 - DEVICE_FLASHMEM_WORDS*2)
